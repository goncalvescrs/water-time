...
const Register = ({}) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!name || !email || !password || !age || !weight || !sleepHours || !bottle) {
        ...
        <>
            ...
            <div className="page">
                <div className="container">
                    ...
                    <div className="form-signin w-100 m-auto" style={{textAlign: "left"}}>
                        ...
                        <form className="needs-validation"  onSubmit={handleSubmit}>
                            ...
                            <button className="button btn btn-primary w-100 btn-lg" type="submit">
                                {'Cadastrar'}
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="bottom-box">
                        <span>Ja tem uma conta? <a className="register" href="#" onClick={() => navigate('/login')}>Entre</a></span>                    
